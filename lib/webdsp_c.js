...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'webdsp_c.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'webdsp_c.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'webdsp_c.temp.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "webdsp_c.js.mem" : null;
...
Module["asm"] = asm;
var _edgeManip = Module["_edgeManip"] = function() { return Module["asm"]["_edgeManip"].apply(null, arguments) };
var _grayScale = Module["_grayScale"] = function() { return Module["asm"]["_grayScale"].apply(null, arguments) };
